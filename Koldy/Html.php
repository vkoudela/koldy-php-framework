...
class Html {
	...
	/**
	 * Truncate the string properly
	 * @param string $string
	 * @param int $length default 80
	 * @param string $etc suffix string
	 * @param bool $break_2words default false, true to cut the words in text
	 * @param bool $middle default false
	 * @return string
	 */
	 ...
	 * @link http://docs.sencha.com/ext-js/4-1/#!/api/Ext.String-method-format
