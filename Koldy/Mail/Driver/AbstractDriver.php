...
abstract class AbstractDriver {
	 ...
	 * @link http://koldy.net/docs/mail#example
	 */
	abstract public function replyTo($email, $name = null);
	 ...
	 * @link http://koldy.net/docs/mail#example
	 */
	abstract public function cc($email, $name = null);
	 ...
	 * @link http://koldy.net/docs/mail#example
	 */
	abstract public function bcc($email, $name = null);
	 ...
	 * @return string
	 */
	protected function getAddressValue($email, $name) {
